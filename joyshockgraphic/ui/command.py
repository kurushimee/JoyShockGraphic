...
class CmdWidget(QWidget):
    ...
    def __init__(self, object_name: str, cmd_id: int, icon: QPixmap, parent=None):
        ...
        self.lName = QLabel("", objectName=f"l{object_name}_{cmd_id}")
        self.lName.setFont(QFont("Segoe UI", 16))
        self.pbBind = QPushButton("None", objectName=f"pb{object_name}_{cmd_id}")
        self.pbBind.setFont(QFont("Segoe UI", 16))
        self.pbSettings = QPushButton("", objectName=f"pb{object_name}Settings_{cmd_id}")
        self.pbSettings.setIcon(QIcon(QPixmap("./joyshockgraphic/resources/icons/cogwheel.png")))
        self.pbSettings.setIconSize(QSize(24, 24))
        self.pbRemove = QPushButton("", objectName=f"pb{object_name}Remove_{cmd_id}")
        self.pbRemove.setIcon(QIcon(QPixmap("./joyshockgraphic/resources/icons/minus.png")))
